...
const Equipos = () => {
    ...
    // Mock Data - Teams
    const teams = [
        { id: 1, name: 'Las Adelitas', players: 14 },
        { id: 2, name: 'Guerreras', players: 12 },
        { id: 3, name: 'Cobras FC', players: 13 },
        { id: 4, name: 'Fénix', players: 11 },
        { id: 5, name: 'Águilas', players: 15 },
        { id: 6, name: 'Leonesses', players: 10 },
    ];
        ...
        <div className="w-full min-h-screen pb-24 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                {teams.map((team) => (
                    <div
                        key={team.id}
                        onClick={() => navigate(`/equipo/${team.id}`)} // Pre-wired for next screen
                    ...
                    >
                        ...
                        {/* Logo Placeholder */}
                        <div className="relative w-24 h-24 md:w-32 md:h-32 bg-white/5 rounded-full flex items-center justify-center border-2 border-white/10 shadow-[0_0_20px_rgba(0,0,0,0.3)] group-hover:scale-110 group-hover:border-blue-400/30 transition-all duration-300">
